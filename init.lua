...
local frm = default.chest_formspec or "size[8,9]"..
...
local function can_replace(pos)
	...
	if minetest.registered_nodes[n.name]
...
local function make_grave(pos)
	...
	minetest.after(2, fill_grave, vector.new(pos))
	--[[pos.y = pos.y+1
